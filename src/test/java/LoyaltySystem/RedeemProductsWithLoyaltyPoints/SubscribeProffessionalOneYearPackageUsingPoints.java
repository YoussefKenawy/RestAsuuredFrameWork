...
public class SubscribeProffessionalOneYearPackageUsingPoints extends BaseTest
    {
    ...
    public void redeemPointForSubscribePremiumOneMonthPackage() throws InterruptedException
        {
            Thread.sleep(5000);
            Map<String, Object> requestBody = Map.of("packageName", "PROFESSIONAL_ONE_YEAR", "paymentMethod", "LOYALTY_CREDIT");
